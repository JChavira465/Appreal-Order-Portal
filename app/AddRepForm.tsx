...
import { addRep, type AddStaffResult } from "./team-actions";

const initialState: AddStaffResult = null;

export function AddRepForm() {
  const [state, formAction, pending] = useActionState(addRep, initialState);

  return (
    <form action={formAction} className="mt-6 space-y-3">
      <p className="text-sm font-medium text-black">Add a rep</p>
      <input
        name="fullName"
        type="text"
        required
